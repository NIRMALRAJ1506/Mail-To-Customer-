...
insert into bank.Customer(CName,CEmail,Contact) values ('Nirmal','nirmal@gmail.com',9876543210)
insert into bank.Customer(CName,CEmail,Contact) values ('Raj','raj@gmail.com',9876543211)
insert into bank.Customer(CName,CEmail,Contact) values ('Sam','sam@gmail.com',8765432167)
